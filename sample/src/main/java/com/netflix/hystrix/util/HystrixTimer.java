...
public class HystrixTimer {
     ...
     * <p>
     * NOTE: This will result in race conditions if {@link #addTimerListener(TimerListener)} is being concurrently called.
     * </p>
     */
    ...
    /* package */ static class ScheduledExecutor {
        /* package */ volatile ScheduledSingleThreadExecutor executor;
        ...
        public void initialize() {
            ...
            executor = new ScheduledSingleThreadExecutor(threadFactory);
            initialized = true;
        }

        public ScheduledSingleThreadExecutor getThreadPool() {
            return executor;
        }
