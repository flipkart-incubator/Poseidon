...
public final class ChannelObservable {
     ...
     * <p>
     *
     * @param channel the source {@link ReceivePort}
     * @param <T>     the type of messages on the channel and the type of items to be
     ...
     *
     * @param channel   the source {@link ReceivePort}
     * @param scheduler the scheduler on which the Observable is to emit the messages received on the channel
     * @param <T>       the type of messages on the channel and the type of items to be
     *                  emitted by the resulting Observable
