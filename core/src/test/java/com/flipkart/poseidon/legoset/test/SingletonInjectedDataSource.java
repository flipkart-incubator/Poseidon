...
@Name(PoseidonLegoSetTest.INJECTED_SINGLETON_DS_NAME)
@Version(major = 4, minor = 1, patch = 6)
public class SingletonInjectedDataSource extends AbstractDataSource {
    @Inject
    public SingletonInjectedDataSource(LegoSet legoset, Request request, @SystemDataSource(PoseidonLegoSetTest.SYSTEM_INJECTABLE_DS_NAME + "_4.1.6") InjectableSystemDataSource dataSource) {
