...
@Singleton
@Name(PoseidonLegoSetTest.SYSTEM_INJECTABLE_DS_NAME)
@Version(major = 4, minor = 1, patch = 6)
public class InjectableSystemDataSource extends AbstractDataSource {
    @Inject
    public InjectableSystemDataSource(LegoSet legoset, Request request, @ServiceClient TestClient testClient) {
