 ...
 */
@Name(PoseidonLegoSetTest.QUALIFIER_INJECTABLE_DS_NAME)
@Version(major = 4, minor = 1, patch = 6)
public class InjectableQualiferDataSource extends AbstractDataSource {

    @Inject
    public InjectableQualiferDataSource(LegoSet legoset, Request request, @Qualifier("test") String injected) {
